...
- Карта 30%; Все остальные параметры генерации кроме сида не трогать, сид может быть любым
- Перемещение караваном по глобальной карте не разрешено
...
Заявки на участие в турнире принимаются до <t:1754730000:D>. После окончания приёма заявок в течение недели мы исправим все ошибки и проблемы и начнём основной этап.
			...
			self.embed(
				description = """
## [🗃️ Нужные файлы 🔗](https://drive.google.com/drive/folders/1Cj3r3xmrhbSOarYRJnZ1-Cl9CGJHXKp_?usp=sharing)
...
**Файл "ТЕСТОВЫЙ ЭТАП Турнир RuinShip.rsc" (Сценарий турнира) поместить по этому пути**
