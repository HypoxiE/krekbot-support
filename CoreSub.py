...
## Начало запланировано на <t:1755248400:D>, так что наберитесь терпения и подождите ещё немного
				"""
			),
			self.embed(
				description = """
## 📋Общая информация о турнире Ruin ~~Our~~ Ship
**Полную информацию о турнире, гайды и правила можно посмотреть на [этом сайте 🔗](тут пока ничего нет, 15 августа 2025 года в момент начала турнира будет)**
